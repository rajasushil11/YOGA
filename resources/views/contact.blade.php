...
<html lang="en">
  <head>
	...
	<!-- Required meta tags -->
     <meta name="description" content="We are committed to providing the best yoga alliance certified yoga teacher training course to Yoga enthusiast. Just send us your concern or questions regarding yoga teacher training. We will give you the help you need." />
    <meta name="keywords" content="Yoga Alliance Certified Yoga Teacher Training Course"/>
    <meta name="topic" content="Inquire, book here"/>
    <meta name="abstract" content="yoga weekends, yoga vacations, yoga holidays, yoga schools in nepal, yoga school in pokhara, registered yoga schools in nepal,  "/>
    <meta name="author" content=""/>
    <title>Contact Us for Yoga Alliance Certified Yoga Teacher Training Course</title>
    <meta charset="utf-8">
...
<section class="mb-5">
    <div class="banner">
      <img src="{{ url('content/img/contact1500.jpg') }}" alt="free yoga in nepal" class="img-fluid d-none d-md-block">
      <img src="{{ url('content/img/contact765.jpg') }}" alt="free yoga retreat" class="d-block d-md-none">
...
<section>
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <form action="{{ url('emails/welcomeMail') }}" accept-charset="UTF-8" method="POST" >
          {{ csrf_field()}}
          <div class="contact-form mb-5">
            <h4 class="myclr mb-4">BOOK HERE/INQUIRE US</h4>
            <div class="form-group">
              <label for="" class="myclr">YOUR NAME</label>
              <input type="text" name="name" placeholder="Enter Name" class="form-control" data-parsley-required="true" data-parsley-error-message="Please enter your name." required />
            </div>
            <div class="form-group" class="myclr">
              <label for="" class="myclr">YOUR EMAIL</label>
              <input type="email" name="email" placeholder="Enter Email" class="form-control" data-parsley-type="email" data-parsley-required="true" data-parsley-error-message="Please enter your valid email." data-parsley-trigger="change" required />
            </div>
            <div class="form-group">
              <label for="" class="myclr">SUBJECT</label>
              <input type="type" name="subject" placeholder="Subject" class="form-control" />
            </div>
            <!--<div class="form-group mb-4">
              <label for="" class="myclr">SELECT YOUR COURSE/SERVICE</label>
              <select name="service" class="btn btn-lg btnSel d-block">
                <option value="200houryttc">200 HOUR YTTC</option>
                <option value="300houryttc">300 HOUR YTTC</option>
                <option value="500houryttc">500 HOUR YTTC</option>
              </select>

            </div>
            <div class="accom-radio">
              <h3 class="myclr mb-3">ACCOMODATION</h3>
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" value="Private" name="Private">Private
                </label>
              </div>
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" value="Double-Shared" name="Double-Shared">Double Shared
                </label>
              </div>
              <div class="form-check-inline">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" value="Triple-Shared" name="Triple-Shared">Triple Shared
                </label>
              </div>
          </div>-->
          <div class="form-group">
            <label for="" class="myclr">YOUR MESSAGE</label>
            <textarea name="message" class="form-control" cols="30" rows="8"></textarea>
          </div>
          <div class="text-left">
            <input type="submit" value="Submit" class="btn btn-success btnCust">
          </div>
          </div>
      </form>
      </div>
      <div class="col-md-5">
        <div class="contact-info">
          <h3 class="myclr mb-4">CONTACT INFORMATION</h3>
          <div class="form-group">
            <label for="" class="myclr"><i class="fa fa-whatsapp" aria-hidden="true"></i> PHONE</label>
            <p> MOBILE/WHATSAPP: +977 9846265340</p>
          </div>
           <div class="form-group">
            <label for="" class="myclr"><i class="fa fa-map-marker" aria-hidden="true"></i> ADDRESS</label>
            <p>
                Begnas, Pokhara 31<br>
                Kaski, Nepal
            </p>
          </div>
          <div class="form-group">
            <label for="" class="myclr"><i class="fa fa-envelope" aria-hidden="true"></i> EMAIL</label>
            <p>shivalayayogaschool975@gmail.com</p>
          </div>
        </div>
      </div>
    </div>
