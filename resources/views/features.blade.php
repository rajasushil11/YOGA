...
<script>
  ...
  gtag('config', 'UA-143349823-1');
    ...
    <link rel="stylesheet" href="{{ url('content/css/features.css') }}">
    <link rel="stylesheet" href="{{ url('content/css/featuresresponsive.css') }}">
  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-white navbar-expand-lg sticky-top p-0">
      ...
      <ul class="navbar-nav w-100 justify-content-around">
        ...
        <li class="nav-item"><a class="nav-link bookbtn" href="https://www.yogi360.com/shivalaya-yoga-ashram-reservation">BOOK NOW</a></li>
      </ul>
      </div>
    </nav>
...
<section class="mb-5">
    <div class="banner">
      <img src="{{ url('content/img/featuresbg1500.png') }}" alt="banner-image" class="img-fluid d-none d-md-block">
      <img src="{{ url('content/img/featuresbg765.png') }}" alt="banner-image" class="d-block d-md-none">
...
<section>
  <div class="container mb-5">
    <div class="accommodation">
      <h3>ACCOMMODATION</h3>
      <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae, ad, delectus. Aliquam odit culpa maiores obcaecati cum, laudantium enim suscipit iure itaque reprehenderit qui minima quisquam perspiciatis, similique dolores pariatur!</p>
      <div class="accomm">
        <ul class="accomm-list">
          <li>Private</li>
          <li>Double shared</li>
          <li>Triple shared</li>
        </ul>
    ...
    <div class="row">
      <div class="col-md-4 px-5 my-3">
        <div class="accomm-pic">
          <img src="{{ url('content/img/accommo-features.png') }}" alt="accommodation-shivalaya">
        </div>
      </div>
      <div class="col-md-4 px-5 my-3">
        <div class="accomm-pic">
...
<section>
  ...
  <div class="food">
    <h3>FOOD</h3>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus distinctio vero minima saepe facilis? Earum obcaecati, distinctio! Nulla alias quo, pariatur ipsum necessitatibus temporibus nisi?</p>
  </div>
    <div class="row">
      <div class="col-md-4 px-5 my-3">
        <div class="food-pic">
          <img src="{{ url('content/img/food-features.png') }}" alt="food-shivalaya">
        </div>
      </div>
      <div class="col-md-4 px-5 my-3">
        <div class="food-pic">
