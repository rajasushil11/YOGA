...
<head>
  ...
  <title>Chakra Awakening Retreat | Nepal Spiritual</title>
    ...
    <meta name="abstract" content="7 Days Chakra Awakening Retreat, Spiritual retreats, 7 Days Chakra Awakening Retreat in Nepal, Retreats for 7 days in nepal, Retreats in Nepal"/>
    <meta property="og:image" content="{{ url('content/img/retreats/yoga-chakra-journey/chakra-thumb.jpg')}}"/>
...
<section class="mb-5 mt-5">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-7">
        <div class="">
          <h1>Chakra Awakening Retreat</h1>
        </div>
         <ul id="imageGallery">
            ...
            <div class="col-md-5 d-md-none d-sm-block mt-5 d-flex align-items-center justify-content-center">
                <table class="tg" width="350px">
                  ...
                  <tr>
                    <td class="tg-xnaw" colspan="2"><span style="font-weight:700">21 APRIL - 28 APRIL 2020</span></td>
                  </tr>
                  <tr>
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="description">
          ...
          <p>The Chakras are our energy centers that perceive, transform and distribute subtle
energy throughout the body. These centers are very important for our physical,
emotional and spiritual health. It's important to open your chakras and maintain
them balanced in order to allow the life energy (prana) flows smoothly as well as
to maintain harmony in the mind, body and soul. If you experience such emotions
as: anger, jealousy, fear, insecurity or have low self-esteem, it means some of your
energetic centers are off balance.</p> 
          <p>Our 7days retreat will reveal the secrets of chakra opening and alignment aligning
through practicing ancient techniques such as: cleansing, asana, pranayama, mudra,
bhanda, bija mantras and meditation. Each day will be dedicated to the one of the
7
th chakras. Make this step for unlocking your potential together with us!</p>
          <p>Along with theory, practice, tricks and tips for chakra balancing.</p>
          </div>
        </div>
      </div>
      <div class="col-md-5 d-md-none d-sm-block mt-5 d-flex align-items-center justify-content-center">
                <table class="tb2" width="350px">
                  ...
                  <tr>
                    <td class="tb2-mqa1" colspan="3">YOGINI GOPIKA & YOGINI MEERA</tr>
                </table>
            </div>
      <div class="col-md-5 d-none d-md-block">
...
<section class="mb-5">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <h3>Yoga Sadhana Retreat Includes:</h3>
        <ul class="curriculum-includes">
          <li>Daily Yoga Classes</li>
          <li>Pranayama & Meditation Practice</li>
          <li>Lectures and Workshops</li>
          <li>Personal approach</li>
          <li>Three Delicious Vegetarian Meals prepared from Organic farm</li>
          <li>New Comfortable Rooms with Hot showers</li>
        </ul>
        
        <h3>You will also Experience:</h3>
        <ul class="daily-includes">
         
          <table class="dlsch">
                      <tr>
                        <th class="dlsch-5pq7" colspan="2"><span style="color:rgb(255, 255, 255)">Retreat: Daily Schedule</span></th>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">Day 1</td>
                        <td class="dlsch-hfrq">Mooladhara chakra. Grounding. Connecting to the mother Earth, trip into the forest</td>
                      </tr>
                      <tr>
                        <td class="dlsch-91og">Day 2</td>
                        <td class="dlsch-91og"> Swadhisthana. Enjoyment with awareness. Art and dancing sessions</td>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">Day 3</td>
                        <td class="dlsch-hfrq">Manipura. Insight. Mastering your forces</td>
                      </tr>
                      <tr>
                        <td class="dlsch-91og">Day 4</td>
                        <td class="dlsch-91og">Anahata. Loving day. Heart opening. Wound healing.</td>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">Day 5</td>
                        <td class="dlsch-hfrq">Vishuddhi. Creative expression. Awareness of the universal energy.</td>
                      </tr>
                      <tr>
                        <td class="dlsch-91og">Day 6</td>
                        <td class="dlsch-91og">Ajna. Spiritual Will. New vision. 3rd eye opening for intuitive power</td>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">Day 7</td>
                        <td class="dlsch-hfrq">Sahasrara. Conjunction with divine.</td>
                      </tr>
                    </table>
        </div>
