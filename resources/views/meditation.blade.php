...
<section class="mb-5">
    <div class="banner">
      <img src="{{ url('content/img/medbg1500.png') }}" alt="banner-image" class="img-fluid d-none d-md-block">
      <img src="{{ url('content/img/medbg765.png') }}" alt="banner-image" class="d-block d-md-none">
...
<section>
  <div class="container mb-5">
    ...
    <div class="row">
      <div class="col-md-7">
        <div class="medi-img">
          <img src="{{ url('content/img/meditationmainimg.png') }}" alt="meditation mainimg">
        </div>
      </div>
      <div class="col-md-5">
        <div class="medi-content">
          <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero assumenda ducimus eveniet officia natus. Suscipit officia, provident sunt dolorum. Numquam, ea quidem, necessitatibus aliquam natus culpa deleniti inventore sit velit vero libero molestiae ipsam perferendis eius tenetur unde doloribus voluptas eaque tempore. Fuga optio exercitationem, dignissimos odit ex, cupiditate recusandae provident laudantium minima, neque repellendus aliquid assumenda laborum sunt accusamus aut corporis sed! Natus nihil iste placeat quasi molestias!</p>
          <p class="lead"> Illo fugiat eos nam harum suscipit voluptates illum sint eligendi necessitatibus dolorum mollitia neque nisi voluptas officiis labore, repellat et dolores ea minima inventore architecto vel quod laboriosam veritatis. Aliquid, voluptate?</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container text-center">
    ...
    <div class="row">
      <div class="col-md-4 px-5 my-3">
        <div class="imgMedi container">
          <img src="{{ url('content/img/med-img1.png') }}">
          <a class="btn btnCust">7 DAY MEDITATION PROGRAM</a>
        </div>
      </div>
      <div class="col-md-4 px-5 my-3">
        <div class="imgMedi container">
          <img src="{{ url('content/img/med-img2.png') }}">
          <a class="btn btnCust">15 DAY MEDITATION PROGRAM</a>
        </div>
      </div>
      <div class="col-md-4 px-5 my-3">
        <div class="imgMedi container">
          <img src="{{ url('content/img/med-img3.png') }}">
          <a class="btn btnCust">30 DAY MEDITATION PROGRAM</a>
        </div>
      </div>
    </div>
  </div>
