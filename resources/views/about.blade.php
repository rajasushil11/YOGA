...
<html lang="en">
  ...
  <title>A Spiritual Heaven for Yogis - Nepal Spiritual | About Us</title>
   <meta name="description" content="Nepal Spiritual is a spiritual Heaven for yogis, seekers and anyone pursuing wisdom, peace, and divine transformation. We are open to welcome groups as well as individual travellers." />
    <meta name="keywords" content="Nepal Spiritual, Multi Yoga teacher School, Yoga Teacher School in Nepal,Yoga instructor course in  Nepal,Yoga Teacher Training Course in Nepal "/>
    <meta name="topic" content="Yoga Teacher Training Course in Lekhnath, Nepal "/>
    <meta name="abstract" content=" Nepal Spiritual –Nepal welcomes all the aspiring Yoga Teachers & Practitioners for the 200 Hour Hatha Yoga Teacher Training Course in Nepal, India registered with Yoga Alliance USA"/>
...
<section>
    	<div class="banner">
    		<img src="{{ url('content/img/yttcbg1500.jpg') }}" alt="yoga teacher training himalayas" class="img-fluid d-none d-sm-block">
    		<img src="{{ url('content/img/yttcbg765.jpg') }}" alt="himalayan yoga" class="img-fluid d-block d-sm-none">
...
<section>
  <div class="container mt-4 mb-4">
    ...
    <p class="lead">Nepal Spiritual is a spiritual heaven for yogis, seekers and anyone pursuing wisdom, peace, and divine transformation. The ashram is sequestered on a hilltop overlooking the breath-taking Begnas Lake in Nepal.</p>

    <p class="lead">We believe yoga is one of the most valuable gifts of nature. Our environment, practices, and teachings are strongly bound by Mother Earth. Following an authentic Yogic Culture, yoga is taught and practiced around the lake, rivers and mountains. The mountains and forests surrounding our abode recharge our energies as well as calm the mind.</p>
    ...
    <p class="lead">Learning yoga in Nepal is a truly unique and life-changing experience. Nepal is a spiritual destination powerfully linked with the ancient wisdom tradition for centuries. Many great saints and practitioners have dwelled in these very mountains practicing and developing this supreme science. Yoga students sense a very palpable spiritual energy and grace when they spend their time practicing here in the Laps of Himalayas.</p>
  ...
  <div class="footerCust pt-md-5 pb-md-3">
    <div class="container">
      ...
      <div class="container footer-menu mt-5">
        ...
        <p class="text-center copyright-para">Copyright &#169; 2019 
Nepal Spiritual. All rights Reserved.<a href="#">Privacy Policy</a> | <a href="#">Terms & conditions</a></p>
      </div>
    </div>
  </div>
  </div>
