...
<html lang="en">
  <head>
    ...
    <meta name="abstract" content=" shivalayayogaashramam is on eof the best yoga teacher training center in Nepal with top notch Facilities in Residental and Accomodation along with various curriculum bases"/>
    <meta name="author" content="shivalayayogaashram"/>
  </head>
  <body>
    <div class="logo-div bg-white"><a href="{{ url('/') }}"><img src="{{ url('content/img/logo.png') }}" alt="Yoga for Beginners in nepal"></a></div>
    <nav class="navbar navbar-light bg-white navbar-expand-lg sticky-top p-0">
      <a class="navbar-brand p-0" href="{{ url('/') }}"><img src="{{ url('content/img/logo.png')}}" alt="Shivalaya Yoga Ashram with 100:200hours "></a>
...
<section class="mb-5">
    <div class="banner">
      <img src="{{ url('content/img/beginnersbg1500.png') }}" alt="beginners yoga pokhara" class="img-fluid d-none d-md-block">
      <img src="{{ url('content/img/beginnersbg765.png') }}" alt="beginners yoga kathmandu" class="d-block d-md-none">
      <div class="text-on-banner">
        <div class="text-on-img">
          <h3 class="">BEGINNERS YOGA</h3>
        </div>
      </div>
    </div>
</section>
<section>
  <div class="container mb-5">
    <div class="beginners-div">
    <h3>Yoga retreat at shivalaya</h3>
    <small>YOGA FOR BEGINNERS</small>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt, voluptate et ipsa similique quas, recusandae.</p>
    <div class="beginners-yoga-list">
      <ul>
        <li>Walking is Yoga</li>
        <li>Running is Yoga</li>
        <li>Office is yoga</li>
        <li>Driving is yoga</li>
      </ul>
    </div>
    <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores nisi aliquid quod praesentium voluptatem cum necessitatibus, beatae voluptatibus! Recusandae, odio!</p>
  </div>
  </div>
</section>
...
<section>
  <div class="container mb-5">
    <h4 class="text-center mb-5">Yoga is way of life, come and learn to be lively</h4>
    <div class="row">
      <div class="col-md-7">
        <div class="img-beginners">
          <img src="{{ url('content/img/meditationmainimg.png') }}" alt="beginners yoga nepal">
        </div>
      </div>
      <div class="col-md-5">
        <div class="beginners-content">
          <h3>YOGA FOR HEALTH AT SHIVALAYA</h3>
          <p class="lead">Yoga is much more than Asana-it is a lifestyle and at shivalaya yoga ashram we prepare students who can live yoga - not just do yoga</p>
          <p>Our packages consists of the following teachings</p>
           <div class="beginners-list">
            <ul>
              <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, porro.</li>
              <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, porro.</li>
              <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, porro.</li>
              <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, porro.</li>
              <li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, porro.</li>
...
<section>
  <div class="container mb-5">
    ...
    <h3 class="mb-0">Yoga retreat options</h3>
    <small>click below to book and inquire about the packages</small>
    </div>
    <div class="row">
      <div class="col-md-4">
        <div class="retreat-options text-center">
          <h3>3 days / 3 nights</h3>
          <div class="grp-buttons">
            <button class="btn btn-lg">Private Single room:<span> </span></button>
            <button class="btn btn-lg">Shared room:<span> </span></button>
            <button class="btn btn-lg">Triple shared room:<span> </span></button>
          </div>
        </div>
      </div>
      <div class="col-md-4">
