...
<head>
	...
	<title>Book Advanced 500 Hour Yoga teacher Training - Pokhara, Nepal</title>
	 <meta name="description" content="The 500 Hour Yoga Teacher Training program is created keeping in mind, yoga aspirants; who want to immerse themselves and acquire significant understanding of yogic methods and culture." />
    <meta name="keywords" content="500 hours yoga teacher training in nepal"/>
    <meta name="topic" content="500 hours Yoga teacher training course in Nepal:500 hrs YTTC"/>
    <meta name="abstract" content="Nepal Spiritual provides the world best yoga center in Nepal with 500 hours with best accomodation for stay and zeal to learn Yoga"/>
    <meta name="author" content="Nepal Spiritual"/>
...
<section class="mb-5">
	<div class="container">
		...
		<div class="row w-100">
			<div class="col-md-7">
				<div class="">
					<h3>500 HOURS Yoga Teacher Training Course</h3>
				</div>
				<ul id="imageGallery">
					  <li data-thumb="{{ url('content/img/500yttc1.jpg') }}" data-src="{{ url('content/img/500yttc1.jpg') }}">
					    <img src="{{ url('content/img/500yttc1.jpg') }}" alt="500 hour best yoga teacher training"/>
					  </li>
					  <li data-thumb="{{ url('content/img/500yttc2.jpg') }}" data-src="{{ url('content/img/500yttc2.jpg') }}">
					    <img src="{{ url('content/img/500yttc2.jpg') }}" alt="Top 500 hour yoga ttc in Nepal"/>
					  </li>
					  <li data-thumb="{{ url('content/img/500yttc3.jpg') }}" data-src="{{ url('content/img/500yttc3.jpg') }}">
					    <img src="{{ url('content/img/500yttc3.jpg') }}" alt="yoga teacher training School "/>
					  </li>
					  <li data-thumb="{{ url('content/img/500yttc4.jpg') }}" data-src="{{ url('content/img/500yttc4.jpg') }}">
					    <img src="{{ url('content/img/500yttc4.jpg') }}" alt="Multi Style Yoga School : 500 hr yoga for Masters in India"/>
					  </li>
					</ul>
			</div>
             ...
             <div class="col-md-5 d-md-none d-sm-block mt-5 d-flex align-items-center justify-content-center">
                <table class="tg" width="350px">
                  ...
                  <tr>
                    <td class="tg-xnaw" colspan="2"><span style="font-weight:700">01 APRIL - 31 MAY 2020</span></td>
                  </tr>
                  <tr>
                    <td class="tg-fxkg" colspan="2">PRICE</td>
                  </tr>
                  <tr>
                    <td class="tg-qmtv">PRIVATE ROOM<br><br><span style="color:rgb(51, 51, 51)">$3200 USD</span><br>
                    <a href="https://www.shivalayayogaashram.com.np/details"><button class="btn btn-default btnCust mt-3 mb-2">BOOK NOW</button></a>
                    </td>
                    <td class="tg-qmtv">SHARED ROOM<br><br><span style="color:rgb(51, 51, 51)">$2800 USD</span><br>
		...
		<div class="row">
			<div class="col-md-7">
				<div class="description">
					...
					<p>The 500 Hour Yoga Teacher Training program is created keeping in mind, yoga aspirants; who want to immerse themselves and acquire significant understanding of yogic methods and culture.</p>
					<p>The 500 Hours YTT is a combination of 200 and 300 hours YTT rolled into one. In this YTT, you would gain expertise in :</p>
					
					<ul>
						<li>Hatha Yoga</li>
						<li>Ashtanga Yoga</li>
						<li>Yoga Anatomy</li>
						<li>Adjustment and Alignment</li>
						<li>Shatkriyas</li>
						<li>Yoga Philosophy</li>
						<li>Modify various asanas for procuring specific benefits and target advantages.</li>
					</ul>
					</div>
				</div>
			</div>
			<div class="col-md-5 d-md-none d-sm-block mt-5 d-flex align-items-center justify-content-center">
                <table class="tb2" width="350px">
                  ...
                  <tr>
                    ...
                    <td class="tb2-mcqj"><span style="font-weight:700">02 MONTHS</span></td>
                  </tr>
                  <tr>
...
<section class="mb-5">
	<div class="container">
		<div class="row">
			<div class="col-md-7">
				<!-- <h3>500 Hour yoga TTC Curriculum includes:</h3> -->
				<!-- <ul class="curriculum-includes">
					<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas sed placeat natus, labore, omnis aperiam.</li>
					<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas sed placeat natus, labore, omnis aperiam.</li>
					<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas sed placeat natus, labore, omnis aperiam.</li>
					<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas sed placeat natus, labore, omnis aperiam.</li>
					<li>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas sed placeat natus, labore, omnis aperiam.</li>
		   ...
		   <!-- <p>Refer <a href="https://www.shivalayayogaashram.com.np/500-hour-yttc-curriculum" target="blank_o">course curriculum</a> for detail course information</p> -->
