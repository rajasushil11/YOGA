...
<head>
	...
	<title>Best RYT 300 Hour Yoga Teacher Training in Nepal | Nepal Spiritual</title>
	 <meta name="description" content="Book Best RYT 300 hour yoga teacher training in Pokhara, the second largest city located at the foot of the Himalayas in Nepal. Move one step further  " />
    <meta name="keywords" content="300 hours yoga teacher training in Nepal, best ryt 300 hours yoga teacher training, yoga instructor course"/>
    <meta name="topic" content="300 hours YTT, 300 Hours Yoga Teachers Training Course, "/>
    <meta name="abstract" content="300 hours yoga teacher training, RYS 300, yoga teacher certification courses, yoga courses nepal, yoga ashram nepal"/>
...
<section class="mb-5">
	<div class="container">
		...
		<div class="row w-100">
			<div class="col-md-7">
				<div class="">
					<h1>300 HOURS Yoga Teacher Training Course</h1>
				</div>
				<ul id="imageGallery">
					  <li data-thumb="{{ url('content/img/300yttc1.jpg') }}" data-src="{{ url('content/img/300yttc1.jpg') }}">
					    <img src="{{ url('content/img/300yttc1.jpg') }}" alt="teach yoga in nepal"/>
					  </li>
					  <li data-thumb="{{ url('content/img/300yttc2.jpg') }}" data-src="{{ url('content/img/300yttc2.jpg') }}">
					    <img src="{{ url('content/img/300yttc2.jpg') }}" alt="one month yoga teacher training course"/>
					  </li>
					  <li data-thumb="{{ url('content/img/300yttc3.jpg') }}" data-src="{{ url('content/img/300yttc3.jpg') }}">
					    <img src="{{ url('content/img/300yttc3.jpg') }}" alt="best yoga teacher training in nepal"/>
					  </li>
					  <li data-thumb="{{ url('content/img/300yttc4.jpg') }}" data-src="{{ url('content/img/300yttc4.jpg') }}">
					    <img src="{{ url('content/img/300yttc4.jpg') }}" alt="300 hour yoga therapy teacher training"/>
					  </li>
					</ul>
			</div>
            <div class="col-md-5 d-md-none d-sm-block mt-5 d-flex align-items-center justify-content-center">
                <table class="tg" width="350px">
                  ...
                  <tr>
                    <td class="tg-xnaw" colspan="2"><span style="font-weight:700">01 MAY - 31 MAY 2020</span></td>
                  </tr>
                  <tr>
                    <td class="tg-fxkg" colspan="2">PRICE</td>
                  </tr>
                  <tr>
                    <td class="tg-qmtv">PRIVATE ROOM<br><br><span style="color:rgb(51, 51, 51)">$1700 USD</span><br>
                    <a href="https://www.shivalayayogaashram.com.np/details"><button class="btn btn-default btnCust mt-3 mb-2">BOOK NOW</button></a>
                    </td>
                    <td class="tg-qmtv">SHARED ROOM<br><br><span style="color:rgb(51, 51, 51)">$1400 USD</span><br>
			...
			<div class="col-md-5 col-md-5 d-none d-md-block">
					...
					<div class="row w-100">
						<div class="col-md-6">
							<div class="category">
								...
								<p>YOGA</p>
								<h5>DATE</h5>
								<p class="reviews-star">01 MAY - 31 MAY 2020</p>
								<h5>PRICE</h5>
								<p>$1700 - (PRIVATE ROOM)</p>
								<a href="{{ url('/details') }}"><button class="btn btn-default btnCust mb-3" >BOOK NOW</button></a>
								<p>$1400 - (SHARED ROOM)</p>
								<a href="{{ url('/details') }}"><button class="btn btn-default btnCust mb-3" >BOOK NOW</button></a>
							</div>
						</div>
		...
		<div class="row">
			<div class="col-md-7">
				<div class="description">
					...
					<p>The pre-requisite to commence 300 hours YTT is to complete 200 hours YTT.</p>

					<p>One reason why you would want to do the 300-hour Yoga Teacher Training is simply because you have discovered one layer of Yoga after your 200 hour YTT and would like to know what lies beneath the surface. Yoga is a science that has unending possibilities because the more you scratch the surface, the more you create harmony towards your physical, mental and emotional well being.  You begin to realize that it is you who hold the key, to living a fulfilled life.</p>
					<p>To explore the very root of Yoga, to get deeply connected and to carry out your daily routine peacefully, Shivalaya Yoga Ashram provides you  a peaceful and inspiring environment to complete 300 Hours Yoga Teachers Training Course.</p>
					<p>You will be learning from our experienced and qualified teachers who are committed to give you the best tools for your future teaching and success. We are offering you a beautiful transformation that takes you to the next level of spiritual growth..</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-5 d-md-none d-sm-block mt-5 d-flex align-items-center justify-content-center">
                <table class="tb2" width="350px">
                  ...
                  <tr>
                    ...
                    <td class="tb2-mcqj"><span style="font-weight:700">31 DAYS</span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="tb2-mqa1" colspan="3">Nepal Spiritual</td>
                  </tr>
                  <tr>
...
<section class="mb-5">
	<div class="container">
		<div class="row">
			<div class="col-md-7">
           <!-- <p>Refer <a href="https://www.shivalayayogaashram.com.np/300-hour-yttc-curriculum" target="blank_o">course curriculum</a> for detail course information</p> -->
				...
				<table class="dlsch">
                      ...
                      <tr>
                        <td class="dlsch-hfrq">05:30</td>
                        <td class="dlsch-hfrq">Herbal Tea</td>
                      </tr>
                      <tr>
                        <td class="dlsch-91og">06:00</td>
                        <td class="dlsch-91og">Hatha Yoga</td>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">08:00</td>
                        <td class="dlsch-hfrq">Pranayama</td>
                      </tr>
                      <tr>
                        <td class="dlsch-91og">09:00</td>
                      ...
                      <tr>
                        <td class="dlsch-91og">11:00</td>
                        <td class="dlsch-91og">Anatomy</td>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">12:00</td>
                        <td class="dlsch-hfrq">Mantra Chanting</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="dlsch-91og">14:00</td>
                        <td class="dlsch-91og">Self Study</td>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">15:00</td>
                        <td class="dlsch-hfrq">Adjust &amp; Alignment</td>
                      </tr>
                      <tr>
                        <td class="dlsch-91og">16:00</td>
                        <td class="dlsch-91og">Ashtanga</td>
                      </tr>
                      <tr>
                        <td class="dlsch-91og">18:00</td>
                        <td class="dlsch-91og">Meditation</td>
                      </tr>
                      <tr>
                        <td class="dlsch-hfrq">19:00</td>
				...
				<a href="{{ url('/300-hour-yttc-curriculum') }}" class="btn btn-lg detailbtn" target="blank_o">Detail Curriculum</a>
			</div>
			<div class="col-md-5">
				<div class="about-ins">
					<div class="col-md-11">
